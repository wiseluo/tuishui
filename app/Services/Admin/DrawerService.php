...
class DrawerService
{
    ...
    public function drawerIndex($param)
    {
        ...
        $data = array_map(function($value){
            ...
            $item['busines_scope'] = $value['busines_scope'];
            return $item;
        }, $list['data']);
        $list['data'] = $data;
        return $list;
    ...
    public function searchDrawerByNameCustomerId($param)
    {
        $list = $this->drawerRepository->searchDrawerByNameCustomerIdRepository($param);
        $data = array_map(function($value){
            $item = [];
            $item['id'] = $value['id'];
            $item['company'] = $value['company'];

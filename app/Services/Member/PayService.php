...
class PayService
{
    ...
    public function __construct(PayRepository $payRepository, CompanyRepository $companyRepository)
    {
    ...
    public function getCurCompany($cid)
    {
        $company = $this->companyRepository->find($cid);
    ...
    {
        return $this->payRepository->approve($param, $id);
    }

    ...
    <section class="scrollable padder">
        ...
        <section class="panel panel-default">
            <div class="panel-body panel-heading">
                @include('member.common.status', ['link'=>'member/drawer'])
                ...
                <!-- <div data-gctable
                     ...
                     data-operate="2|查看|primary|member/drawer?outer=dradetail&tp=check|820px,2|修改||member/drawer?outer=dradetail&tp=update|820px,2|审核||member/drawer?outer=dradetail&tp=examine|820px,3|删除|danger|member/drawer?tp=del,3|修改||member/drawer?outer=dradetail&tp=xiugai|820px"
...
//     window.location.href="/member/drawer/export?keyword="+ $("#searchName").val();
// });
            ...
            layer.open({
                ...
                yes: function () {
                    ...
                    if (val == 'read') {
                        ...
                        if (val == 'update_done') {
                            url = '/member/drawer/update_done/' + id

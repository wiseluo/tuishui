    ...
    <section class="scrollable padder tsjs">
        ...
        <section class="panel panel-default">
            <header class="panel-heading text-right bg-light" style="height:47px">
                @include('member.common.status', ['link'=>'member/finance/settlement'])
                <!-- <span class="btn btn-sm btn-rounded btn-info">导出excel</span> -->
            </header>
            <div class="panel-body settle">
                ...
                <!-- <div data-gctable
                     ...
                     data-operate="2|详情|primary|member/finance/settlement?outer=seldetail&tp=check|1400px,2|审核||member/finance/settlement?outer=seldetail&tp=examine|1400px,3|结算||member/finance/settlement?outer=settlementdetail&tp=settle"
...
function getHtml(id,val) {
    var url = ''
    outerTitle = ''
    url = '/member/finance/settlement/' + val + '/' + id
    if(val == 'read'){
        outerTitle = '查看'
    }
    if(val == 'approve'){
...
//结算
function toOver(id){
    var url =  '/member/finance/settlement' +'/settle' + '/' + id;
    $.get(url,{},function(str){
        layer.open({
            ...
            yes:function (i) {
                ...
                var postUrl ='/member/finance/settlement/settlesave/'+$('.settlement_id').val();
                console.log(postUrl)

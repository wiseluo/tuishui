        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                <header class="panel-heading text-right bg-light">
                    @include('member.common.status', ['link'=>'member/finance/pay'])
                ...
                <div class="panel-body rem-Ite">
                    ...
                    <!-- <div data-gctable
                         ...
                         data-operate="2|查看|primary|member/finance/pay?outer=paydetail&tp=check|900px,2|修改||member/finance/pay?outer=paydetail&tp=update|900px,2|审核||member/finance/pay?outer=paydetail&tp=examine|900px,2|付款关联||member/finance/pay?outer=payrelate&tp=relate|900px"

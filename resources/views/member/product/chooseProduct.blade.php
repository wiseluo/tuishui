...
<div class="choosePro panel-body">
    ...
    <div class="table-responsive panel" style="width:100%;height: 450px; overflow-x:auto;">
...
<script>
    ...
    function GetEnterprise(page){
        ...
        var html = ''
        $.get('/member/product/product_choose',{keyword:keyword,page:page,action:'data',customer_id:$('.choosePro_customer_id').val()},function (res) {
            console.log(res);

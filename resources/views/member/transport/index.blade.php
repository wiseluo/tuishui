    ...
    <section class="scrollable padder">
        ...
        <section class="panel panel-default">
            <header class="panel-heading text-right bg-light" style="height: 46px">
                <!-- @include('member.common.status', ['link'=>'member/finance/transport'])
                <span class="btn btn-sm btn-primary" onclick="getHtml(0,'save')" title='添加'>添加</span> -->
                <ul class="nav nav-tabs pull-left">
                    <li><a href="/member/transport/3">已登记</a></li>
                </ul>
            </header>
            <div class="panel-body">
                ...
                <!-- <div data-gctable
                     ...
                     data-operate="2|查看|primary|member/finance/transport?outer=tradetail&tp=check|1400px,2|修改||member/finance/transport?outer=tradetail&tp=update|1400px,2|审核||member/finance/transport?outer=tradetail&tp=examine|1400px"
...
<script>
    ...
    function getHtml(id,val) {
        var url = ''
            outerTitle = ''
            url = '/member/finance/transport/' + val + '/' + id
        if(val == 'save'){
            outerTitle = '添加'
        }
        if(val == 'read'){

...
<div class="accdetail panel-body">
    <form class="form-horizontal" style="overflow: hidden;">
        ...
        <div class="form-group">
            <label for="email" class="col-sm-2 control-label necessary_front">公司</label>
            <div class="col-sm-9">
                <input type="text" id="company_name" value="{{ isset($user) ? (isset($user->company) ? $user->company->name:''):'' }}" class="form-control" placeholder="选择公司"   data-outwidth="800px" readonly/>
                    <input type="hidden" id="company_id" name="cid" value="{{ isset($user) ? $user->cid : ''}}" class="form-control" data-parsley-required data-parsley-trigger="change">
            </div>
        </div>

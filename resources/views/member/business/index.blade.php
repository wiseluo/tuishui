    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                <li><i class="fa fa-home"></i> 业务管理</li>
            </ul>
            <section class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="#" class="btn btn-s-md btn-danger m-r-xs pull-right" data-id="0" data-type="2" data-api="member/business?outer=busdetail&tp=call" data-outwidth="600px">新增项目</a>
                    </div>
                    <div data-gctable
                         data-url="/business"
                         data-label="序号,公司,业务类型,合同类型"
                         data-query=".queryForm"
                         data-operate="2|修改||member/business?outer=busdetail&tp=update|1400px,3|删除|info|member/business?tp=del"
                         data-operateFilter=""

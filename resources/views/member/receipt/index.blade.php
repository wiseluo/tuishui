        ...
        <section class="panel panel-default">
            <div class="panel-body">
                ...
                <!-- <div data-gctable
                     ...
                     data-check="true"
                     data-operate="2|查看|primary|member/finance/receipt?outer=recdetail&tp=check|1400px,3|删除||member/finance/receipt?tp=del,1|关联订单||finance/receipt?outer=recdetail_number"
                     data-operateFilter=""
...
<script>
    ...
    function getHtml(id,val) {
        var width = (document.body.clientWidth) * 0.85 + 'px'
            outerTitle = ''
            url = '/member/finance/receipt/' + val + '/' + id
        if(val == 'save'){
            outerTitle = '添加'
        }
        if(val == 'read'){
    ...
    function jump(id){
        window.open('/member/finance/receipt/number/'+id)
    }
    function over(id){
        layer.open({
            title: '结汇',
            ...
            yes: function(index){
                ...
                $.ajax({
                    type: 'post',
                    url: '/member/finance/receipt/exchange/' + id,
                    data:{
                        rate: rate
                    },
                    success: function(res){

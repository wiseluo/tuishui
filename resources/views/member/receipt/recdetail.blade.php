...
<div class="recdetail">
    <form class="form-horizontal customer" style="overflow: hidden;">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 m-t">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="country_openCon form-control" name="country" value="{{ isset($receipt->country->country_na) ? $receipt->country_na : '' }}"
                            placeholder="付款银行所在国家" {{ $disabled }} readonly {{ $disabled }} class="form-control" />
                        <input type="hidden" class="country_openCon" name="country_id" value="{{ isset($receipt->country->country_id) ? $receipt->country_id : '' }}" class="form-control" />
                    </div>
                </div>
            </div>
            @include('member.common.dataselect', ['label'=>'币种', 'var'=>'currency_id', 'obj'=> isset($receipt) ? $receipt : '' ])
        </div>
        <div class="row">
            <div class="col-sm-4 m-t">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 m-t receipt_dom">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-4 m-t" style="margin-bottom: 14px;">
                <div class="form-group">
        ...
        <div class="row">
            <div class="border_size col-sm-12">
                实际收汇
            </div>
            <div class="col-sm-4 m-t">
                <div class="form-group">
...
<script>
    ...
    $(document).on('click','.account_con',function (){
        var th=$(this),
            outerTitle = '选择收款账号'
            api = '/member/curl/erp_enterprise_account';
    ...
    var index = layer.open({
            ...
            yes: function (i,layero) {
                let id = layero.find('.bg-active').data('id'),
                cusname = layero.find('.bg-active .ea_account').text(),
                ea_accountname = layero.find('.bg-active .ea_accountname').text(),
                ea_bankaccount = layero.find('.bg-active .ea_bankaccount').text();
                th.val(cusname)
                th.next().val(id);
                 //收款公司  开户银行
            ...
            success: function(layero, index){
                ...
                function GetEnterprise(page){
                    ...
                    $.get('/member/curl/erp_enterprise_account',{keyword:keyword,page:page,isparsonal:isparsonal},function (res) {

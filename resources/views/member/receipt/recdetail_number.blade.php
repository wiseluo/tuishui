...
<section class="vbox">
    <section class="scrollable padder">
        <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
            ...
            <li><a href="javascript:void(0)">收汇单 <span>123456</span>详情</a></li>
        </ul>
                ...
                <div class="clearfix">
                    <div class="pull-left col-md-6 d_margin">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-8 form-control " readonly>
                                       <span> {{ $receipt->money - $receipt->receipted_amount }} </span>
                                    </div>
                                  </div>
                            </form>
                        </div>
                        <div class="pull-left col-md-6">
                            <form class="form-horizontal">
                                  <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">付款账号:</label>
                                        <div class="col-sm-8 form-control " readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 form-control " readonly>
                                            <span class="  "> {{ $receipt->remitter }} </span>
                                        </div>
                                  </div>
                                    <div class="form-group">
    ...
    $('.nav-tabs li').click(function(){
        ...
        if(page=="#page1"){
            if(Time==true){
                ...
                Time =true;
                var Url ='/member/finance/receipt/order/'+id+'/'+0;
                get_order_list(1)
                    ...
                    $.get(Url, {page:page}, function (str) {
                        ...
                        $('.page1-btn').click(function(){
                            ...
                            if(this_input==''){
                                ...
                                //关联操作 id 金额 order_id
                                var page1uar="/member/finance/receipt/binding/"+id+"?order_id="+order_id+"&money="+this_input;
            ...
            if(Time==true){
                ...
                Time = true
                var Url ='/member/finance/receipt/order/'+id+'/'+1;
                $.get(Url, {}, function (str) {
                    ...
                    $(document).on('click','.page2-btn',function(){
                        ...
                        var page2uar="/member/finance/receipt/unbinding/"+id+"?order_id="+order_id;
                    ...
                    $(document).on('click','.page2-settle',function(){
                        ...
                        var status=5;
                        // /order/update/29
                        var page2settle="/member/order/update/"+order_id;
                    ...
                    $(document).on('click','.page2-cancel',function(){
                        ...
                        var status=3;
                        // /order/update/29
                        var page2cancel="/member/order/update/"+order_id;

<div class="choosePro panel-body">
    <div class="form-group" style="margin-left: 25px">
        {{--<label for="customerName" class="col-lg-4 control-label">单位名称</label>--}}
        <div class=" " style="width: 200px;">
            <input style="width: 200px;float: left" type="text" class="form-control chooseCustomer_name" name="keyword" placeholder="输入单位名称">
        </div>
...
<script>
    ...
    function GetEnterprise(page){
        ...
        $.get('/member/unit/list',{keyword:keyword,page:page,action:'data'},function (res) {

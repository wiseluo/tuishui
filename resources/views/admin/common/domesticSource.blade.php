<!--选择境内货源地-->
<div class="chooseDomestic panel-body">
    <div class="form-group" style="margin-left: 25px">
        {{--<label for="Domestic_name" class="col-lg-4 control-label">境内货源地名称</label>--}}
        <div class=" " style="width: 200px;">
            <input style="width: 200px;float: left" type="text" class="form-control chooseDomestic_name" name="keyword" placeholder="输入境内货源地名称">
        </div>
...
<script>
    ...
    function GetEnterprise(page){
        var keyword = $('.chooseDomestic_name').val()
        var html = ''
            id = $('.choose_customer_id').val()
        $.get('/admin/district/list',{keyword:keyword,page:page,action:'data'},function (res) {

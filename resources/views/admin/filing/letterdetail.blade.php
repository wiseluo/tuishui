    ...
    <form class="form-horizontal" style="overflow: hidden;">
        ...
        <div class="col-sm-4 m-t-sm">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="declared_amount" class="form-control declared_amount" data-parsley-number-message="请输入最多两位小数" data-parsley-number data-parsley-required value="" readonly/>
                </div>
            </div>
        </div>
        <div class="col-sm-4 m-t-sm">
        ...
        <div class="col-sm-12 m-t-sm">
            <div class="form-group">
                <div class="table-responsive panel" style="overflow-x:auto;margin:0 15px;">
                    ...
                    <div class="purpage page_turn" id="invoicePage" style="text-align:center"></div>
                </div>
            </div>
        </div>
    </form>

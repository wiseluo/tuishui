    ...
    <form class="form-horizontal" style="overflow: hidden; border-top:1px solid #cccccc">
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="cusName" value="{{ isset($order) ? (isset($order->customer)?$order->customer->name:'') : (isset($customer) ?  $customer->name : '')}}" class="form-control" placeholder="选择客户" data-select="customer" data-target="[name=customer_id]" data-outwidth="800px" data-parsley-required data-parsley-trigger="change" {{ $disabled }} readonly/>
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="companyName" value="{{ isset($order->company)? $order->company->name:''}}" class="form-control" placeholder="选择经营单位" data-select="company" data-target="[name=company_id]" data-outwidth="800px" data-parsley-required data-parsley-trigger="change" {{ $disabled }} readonly/>
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <select id="clearance_port" class="form-control">
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" readonly value="{{ isset($order->district->district_name) ? $order->district->district_name : ''}}" id="district" class="form-control"  placeholder="选择境内货源地" data-select="district" data-target="[name=district_code]" data-outwidth="800px" data-parsley-required data-parsley-trigger="change" {{ $disabled }}/>
                            ...
                            @foreach($order->drawerProducts as $key => $drawerProducts)
                                <tr data-id="{{ $drawerProducts->id }}">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden"  readonly  data-parsley-type="number" value="{{ $drawerProducts->product->rate }}"  name="pro[{{ $key }}][rate]"  class="text-center rate" >
                                    </td>
                                    <!-- <td>
                                    ...
                                    <td>
                                        <input type="text" name="pro[{{ $key }}][merge]"  value="{{ $drawerProducts->pivot->merge }}" {{ $disabled }} data-parsley-required data-parsley-type="number" data-parsley-trigger="change" >
                                    </td>
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="end_port" class="form-control" value="{{isset($order->ports->port_c_cod) ? $order->ports->port_c_cod : ''}}" readonly>
                    <input type="hidden" data-parsley-required data-parsley-trigger="change" id="unloading_port" class="form-control" name="unloading_port" value="{{isset($order->unloading_port) ? $order->unloading_port : ''}}" readonly>
                </div>
            </div>
        </div>
        <div class="col-sm-4 m-t-xs">
        ...
        <div class="col-sm-4 m-t-xs">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="clearance_mode" value="{{ isset($order) ? $order->clearance_mode : ''}}" name="clearance_mode" class="form-control" readonly/>
                </div>
            </div>
        </div>
        <div class="col-sm-4 m-t-xs">

...
<div class="chooseCus panel-body">
    ...
    <div class="table-responsive panel m-t" style="overflow-x:auto;height: 450px;">
...
<script>
    ...
    function GetEnterprise(page){
        ...
        var html = '';
        $.get('/admin/bnotelist',{number:chooseCusNumber, bnote_sealingnum:chooseCusSealingnum, page:page,action:'data'},function (res) {
            if(res.code == 403){
                layer.msg(res.msg)
                return false
            }
            ...
            $.each(res.data.data,function (a,b) {
                html += '<tr data-id="' + b.bnote_id + '">' +
                    ...
                    '<td class="">' + b.bnote_sealingnum + '</td>' +

    ...
    <section class="scrollable padder">
        ...
        <section class="panel panel-default">
            <header class="panel-body panel-heading">
                @include('admin.common.status', ['link'=>'admin/brand'])
                <div class="pull-right">
                    <span class="btn btn-sm btn-primary" onclick="getHtml(0,'save')">添加</span>
                </div>
            </header>
            <div class="panel-body">
                ...
                <div data-gctable
                     ...
                     data-operate="2|查看|primary|admin/brand?outer=branddetail&tp=check|1400px,2|审核||admin/brand?outer=branddetail&tp=examine|1400px,2|修改||admin/brand?outer=branddetail&tp=update|1400px"
        ...
        success: function (str) {
            ...
            layer.open({
                ...
                yes: function () {
                    ...
                    var flag = validated($(".branddetail form"))
                    if(flag){

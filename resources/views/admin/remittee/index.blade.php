        ...
        <section class="panel panel-default">
            <div class="panel-body">
                ...
                <!-- <div data-gctable
                     ...
                     data-operate="2|修改|primary|admin/finance/remittee?outer=remdetail&tp=update|800px,3|删除||admin/finance/remittee?tp=del"
                     data-operateFilter=""
...
<style>
    .form-inline.form-horizontal.queryForm.gcForm{
        width: 600px;
    }
    .form-inline.form-horizontal.queryForm .form-group{width: 100%}
    .form-inline.form-horizontal.queryForm .col-sm-8{width: 50%}
    .form-inline.form-horizontal.queryForm .control-label.necessary_front{
         width: 50%;
     }
    .form-inline.form-horizontal.queryForm .col-sm-6.m-t-xs{margin-top: 0}
</style>
...
<script>
    ...
    function getHtml(id,val) {
        var url = ''
        outerTitle = ''
        url = '/admin/finance/remittee/' + val + '/' + id
        if(val == 'save'){
            outerTitle = '添加'
        }
        if(val == 'update'){

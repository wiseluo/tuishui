...
<div class="remdetail m-t">
    <form class="form-horizontal" style="overflow: hidden;">
        @include('admin.common.dataselect', ['label'=>'收款单位类型', 'var'=>'remit_type', 'obj'=> isset($remittee) ? $remittee : '', 'col' => 6])
...
<script>
    $(function(){
        ...
        $('.company').off('click').on('click',function (){
            ...
            var api = '/admin/' + company_type + '/choose';

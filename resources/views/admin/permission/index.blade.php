            ...
            <section class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="#" class="btn btn-primary m-r-xs pull-right" data-id="0" data-type="2" data-api="{{ request()->path() }}?outer=perdetail&tp=call" data-outwidth="600px">新增权限</a>
                    </div>
                    <div data-gctable
                         data-url="{{ request()->fullUrl() }}"
                         data-label="序号,权限名称,权限信息,描述"
                         data-query=".queryForm"
                         data-operate="2|修改||admin/system/permission?outer=perdetail&tp=update|1400px,3|删除|danger|admin/system/permission?tp=del"
                         data-operateFilter=""

        ...
        <section class="panel panel-default">
            <header class="panel-body panel-heading text-right bg-light">
                <ul class="nav nav-tabs pull-left">
                    <li><a href="/admin/invoice/3">待申报</a></li>
                    <li><a href="/admin/invoice/5">已申报</a></li>
                    <li><a href="/admin/invoice/6">已退税</a></li>
                    <li><a href="/admin/invoice/order_list">订单</a></li>
                </ul>
                <span class="btn btn-sm btn-primary invoiceExport" data-type="2">导出</span>
                <!-- <span class="btn btn-sm btn-info btn-rounded" data-id="0" data-type="2" data-api="admin/invoice?outer=invdetail&tp=add" data-outwidth="980px">登记发票</span> -->
            </header>
            <div class="panel-body">
                ...
                <!-- <div data-gctable
                     ...
                     data-operate="2|查看|primary|admin/invoice?outer=invdetail&tp=check|1400px"
...
<script>
    $(function(){
        $('.invoiceExport').click(function(){ //导出数据
            window.location.href="/admin/invoice/export?keyword="+ $("#keyword").val();
        });
    });
